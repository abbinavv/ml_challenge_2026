...
| 6 | 26 Sep | sub-06 | v6: cleaning fixes (France regions/departements, key-name collisions, sound-alike mapping of Indian-script words unseen in train, skeleton similarity feature), 450K entities | full re-blocking with current cleaning; France without the common-word shortcut; exact-key passes | global threshold 0.725 | 0.9746 (P 99.4% / R 94.3%) | _pending_ | vs sub05: 18% of French, 11% of Indian, 5% of US entities changed; 6.19 candidates/entity |
