...
| 4 | 25 Sep | sub-04 | v5: same as v4, trained on 450K entities (was 250K) | same candidates as sub03 | global threshold 0.70 | 0.9749 (P 99.4% / R 94.5%; India 0.970, US 0.978) | _pending_ | address fix: dots no longer glue numbers to words ('No.301' -> 301; 10-14% of India addresses); 6.02 candidates/entity; 3.47 matches/entity |
